...
for (i, name) in enumerate(line_names)
    ...
    r_bis_best = dropdims(r_bis_array[r_bis_best], dims=2)
    ...
    r_curve_best = dropdims(r_curve_array[r_curve_best], dims=2)
